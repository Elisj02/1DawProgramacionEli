...
/* Realiza un programa que resuelva lo siguientes puntos:
	...
	b.- En la opción "1" debe pedir dos datos, correspondientes a las longitudes de los dos
	 	catetos de un triángulo. Se debe imprimir la longitud de la hipotenusa. Recuerda que
	 	Hipotenusa al cuadrado = cateto1 al cuadrado + cateto2 al cuadrado.
 
    c.- En la opción "2" debe pedir la longitud del radio de una circunferencia e imprimir la
     	superficie de la misma. Recuerda que el área es igual a PI por el radio al cuadrado. 
     	Recuerda también que PI es igual a 3,1416.
    
    d.- En la opción "3" debe pedir la longitud del radio de una circunferencia e imprimir la
     	longitud del perímetro de la misma. Recuerda que la longitud de la circunferencia = 2 
     	por PI por el radio.
   
    e.- En la opción "4" debe pedir las longitudes de la base y la altura de un rectángulo, e
     	imprimir el área de dicho rectángulo. Recuerda que el área del rectángulo es igual a
     	la base por la altura.
  
    f.- En la opción "5" debe pedir la base y la altura de un tríangulo e imprimir el área del
     	mismo. Recuerda que el área del triángulo es la mitad del área del rectángulo de igual
     	base y altura.
    
    g.- Tras mostrar el resultado de cada opción, el programa debe hacer una pausa
     	(para poder observar el resultado), y volver a pintar el menú. Esto se repetirá
     	siempre que la opción no sea "0", en cuyo caso el programa acabará.
    
    h.- Si la opción no fuese "0", "1", "2", "3", "4" o "5", el programa deberá dar el
     	mensaje de "opción incorrecta" y volverá a mostrar el menú.
 */
		String str;
		int opcion;
		double hipotenusa, percircun, perimetro, arearect, areatr, cateto1, cateto2, longrad,
		areacircun, baser, alturar, baset, alturat;
		do {
			do {
			...
			case 1: System.out.println("Cálculo de la hipotenusa de un triángulo.");
			...
			case 2: System.out.println("Cálculo de la superficie de una circunferencia.");
			...
			case 3: System.out.println("Cálculo del perímetro de una circunferencia.");
			str = JOptionPane.showInputDialog("Introduce la longitud del radio de la circunferencia: ");
			longrad = Double.parseDouble(str);
			...
			case 4: System.out.println("Área del rectángulo.");
			...
			case 5: System.out.println("Área del triángulo.");
