package capitulo7_Acceso_BBDD.windowBuilder;
...
public class VentanaFabricantes implements ChangeListener, ItemListener {
	...
	private void initialize() {
		...
		panel_2.add(radio2);
		bg.add(radio2);
		radio3 = new JRadioButton("Tres");
		radio3.setBounds(10, 120, 100, 30);
		radio3.addChangeListener(this);
		panel_2.add(radio3);
		bg.add(radio3);
		
		// implementamos la interface ChangeListener para capturar el cambio de
		...
		gbl_panel_1.columnWidths = new int[]{93, 71, 69, 63, 30, 0};
		...
		bg = new ButtonGroup();
				...
				gbc_combo1.anchor = GridBagConstraints.NORTHWEST;
				gbc_combo1.gridx = 4;
				gbc_combo1.gridy = 0;
				panel_1.add(combo1, gbc_combo1);
		combo1.addItem("Hola");
		combo1.addItem("Adios");
		combo1.addItem("Hasta luego");
		combo1.addItem("Saludo");
		combo1.addItem("Baips");
		combo1.addItemListener(this);

		// Un evento muy útil con este control es cuando el operador selecciona un Item
		// de la lista. Para capturar la selección de un item debemos implementar la
