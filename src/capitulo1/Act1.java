...
//en una sola fila de la consola de salida.
		...
		// Pido 3 números con srt = JOptionPane.showInputDialog y los guardo en las
		// variables
		...
		System.out.println("El número entero es: " + numentero + " El número flotante es: " + numflotante
